...
export const sampleNotams: NOTAM[] = [
  ...
  },
  {
    ...
    effectiveDate: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000).toISOString(),
    expiryDate: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000).toISOString(),
    published: new Date(Date.now() - 9 * 24 * 60 * 60 * 1000).toISOString(),
    altitudeMin: 0,
    altitudeMax: 2000,
    radius: 3,
    severity: 'medium'
  ...
  },
  {
    ...
    expiryDate: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toISOString(),
    published: new Date(Date.now() - 16 * 24 * 60 * 60 * 1000).toISOString(),
    altitudeMin: 0,
    altitudeMax: 5000,
    radius: 8,
    severity: 'low'
